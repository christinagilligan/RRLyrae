...
#give the star name as an argument for the script
...
#HK col8-col10
#convert the 2MASS magnitudes to IRSF magnitudes
...
JK=catalog[goodIndex,5].astype(float)-catalog[goodIndex,9].astype(float)

JIRSF=catalog[goodIndex,5].astype(float)+-0.048*JH-0.001
HIRSF=catalog[goodIndex,7].astype(float)+0.027*JH-0.009
KIRSF=catalog[goodIndex,9].astype(float)+0.015*JK-0.001
